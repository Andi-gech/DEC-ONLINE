...
export default function Settings() {
  ...
  const mutation = useMutation({
    mutationFn: async (updatedData) => {
      ...
      await axios.put(`https://dec-online-otal.vercel.app/api/user/update/me`, formData, {
        headers: {
      ...
      <div className='w-[80%]  rounded-md flex flex-col'>
        ...
        <div className='w-full flex flex-row'>
          ...
          <div className='w-[50%] flex-1 flex-col flex items-center justify-center'>
            <img
              src={image ? URL.createObjectURL(image) : (data?.data?.profilepic ? `https://dec-online-otal.vercel.app/${data?.data?.profilepic}` : "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png")}
