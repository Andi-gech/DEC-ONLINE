...
const post=async()=>{
  return await axios.post('https://dec-online-otal.vercel.app/api/user/create', { fullName:Fullname, email:Email, password ,role:isTeacher ? 'teacher':'student',confirmpassword })
