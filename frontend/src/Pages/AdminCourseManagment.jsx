...
export default function AdminCourseManagment() {
  ...
  const mutation=useMutation({
    mutationFn:(data)=>axios.put(`https://dec-online-xek6-r74pfr2fz-andigechs-projects.vercel.app/api/admin/courses/approve/${data}`,{},{headers:{'_auth':`${authHeader}`}}),
    onSuccess:()=>{
  ...
  <img src={`https://dec-online-xek6-r74pfr2fz-andigechs-projects.vercel.app/images/${data?.image}`} className='w-full  object-cover  mb-[2px] rounded-md h-[150px]'/>
