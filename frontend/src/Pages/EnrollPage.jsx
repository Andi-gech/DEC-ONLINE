...
export default function EnrollPage() {
  ...
  const mutation=useMutation({
    mutationFn:()=>axios.post(`https://dec-online-xek6-r74pfr2fz-andigechs-projects.vercel.app/api/enroll/pay/${courseid}`,{},{
      headers: {
        '_auth': authHeader
      },
    }),
  ...
  return (
    <div className='sm:ml-[18%] bg-white dark:bg-slate-950 relative sm:w-[82%] w-full h-screen flex sm:flex-row  flex-col  items-center justify-center  sm:px-[100px] overflow-hidden '>
      ...
      <img src={`https://dec-online-xek6-r74pfr2fz-andigechs-projects.vercel.app/images/${course?.data?.image}`} className='w-[450px] h-[350px]  rounded-md'/>
