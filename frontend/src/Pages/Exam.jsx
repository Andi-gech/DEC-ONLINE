...
export default function Exam() {
 ...
 const authHeader = useAuthHeader()
    const Result =async () =>{
      ...
      const res=await axios.post(`https://dec-online-xek6-r74pfr2fz-andigechs-projects.vercel.app/api/enroll/exam/${examid}/evaluate`,{answers:examAnswers},{headers:{'_auth':`${authHeader}`}})
   if(res.status==200){
    console.log(res)
    console.log(res,"res")
