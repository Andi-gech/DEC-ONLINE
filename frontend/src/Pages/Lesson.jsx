...
const mutation = useMutation({
  mutationFn: async (data) => await axios.put(`https://dec-online-xek6-r74pfr2fz-andigechs-projects.vercel.app/api/user/rate/${courseData?.data?.createdBy._id}`, data, {
        headers: {
          '_auth': authHeader
        },
      })
  ...
  const handleComplete = async () => {
    ...
    try {
      const result = await axios.put(`https://dec-online-xek6-r74pfr2fz-andigechs-projects.vercel.app/api/enroll/${courseid}/completemodule`, requestBody, {
        headers: {
          '_auth': authHeader
        },
      });
          ...
          <div className="w-full h-[400px] mt-4 bg-black rounded-md ">
            <div className="w-full h-full">
              ...
              <video className="w-full h-full" autoPlay controls>
                <source src={'https://dec-online-xek6-r74pfr2fz-andigechs-projects.vercel.app/'+courseDetail?.data?.videolink} type="video/mp4" />
              </video>}
            </div>
          </div>
          <ReactQuill
